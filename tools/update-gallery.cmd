@echo off
REM Double-click this file to regenerate images.json + heatmap.json + thumbnails.
REM Scans the images\ folder and rebuilds the gallery manifest, the daily
REM heatmap data and thumbs\ / views\.
